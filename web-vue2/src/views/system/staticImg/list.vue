<template>
  <div>
    ...
    <el-table ref="dataTable" :data="tableData" stripe border @selection-change="handleTableSelectChange"
      ...
      <el-table-column label="文件地址" prop="fileUrl" align="center"/>
    ...
    <el-dialog title="批量导入" :close-on-click-modal="false" :visible.sync="dialogImportVisible"
      ...
      <el-form ref="importForm" label-width="120px" v-loading="isImportLoading">
        ...
        <el-form-item label="导入：">
          <el-upload v-permission="'filesStatic-zFilesStatic-importExcel'"
                     :action="$baseServer+'/filesStatic/zFilesStatic/import/excel'"
...
export default {
  ...
  methods: {
    ...
    exportExcel() {
      ...
      downloadUtil.download('/filesStatic/zFilesStatic/export/excel', params, '静态资源文件表.xlsx')
    },
    // 导入Excel之前，显示loading
    ...
    downloadExcelTemplate() {
      downloadUtil.download('/filesStatic/zFilesStatic/import/downloadTemplate', {}, '静态资源文件表-导入模板.xlsx')
    },
  }
}
</script>
