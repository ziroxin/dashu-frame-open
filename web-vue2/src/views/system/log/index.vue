<template>
  <div class="app-container">
    ...
    <div style="margin-bottom: 20px">
      ...
      />
      <el-input
        v-model="searchData.logMethod"
        style="width: 160px; margin-right: 10px"
        class="filter-item"
        placeholder="输入方法名模糊查询"
      />
      <el-input
      ...
      <div style="float: right">
        <el-button
          v-waves
          v-permission="'zlog-zOperateLog-delete'"
          type="danger"
          @click="deleteByIds"
        >删除
        </el-button>
        <el-button
          v-waves
          v-permission="'zlog-zOperateLog-exportExcel'"
          type="success"
          @click="exportExcel"
        >导出Excel
        </el-button>
    ...
    <el-dialog :title="titleMap[dialogType]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="操作人用户名" prop="userName" :rules="[]">
          <el-input v-model="temp.userName" placeholder="请输入操作人用户名" />
        </el-form-item>
        <el-form-item label="执行方法名称" prop="logMethod" :rules="[]">
          <el-input v-model="temp.logMethod" placeholder="请输入执行方法名称" />
        </el-form-item>
        <el-form-item label="执行方法描述" prop="logMsg" :rules="[]">
        ...
        <el-form-item label="请求路径" prop="actionUrl" :rules="[]">
          <el-input v-model="temp.actionUrl" placeholder="请输入请求路径" />
        </el-form-item>
        <el-form-item label="IP地址" prop="ip" :rules="[]">
