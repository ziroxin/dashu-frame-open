<template>
  <div class="panel">
    ...
    <div class="panel-main">
      <type-block index="1" title="HelloWorld" content="介绍" :progress="80"
      ...
      />
      <type-block index="2" title="面向对象"
                  img="data:image/png;base64,"
                  content="介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍绍介绍介绍"
      />
    </div>
  </div>
</template>
...
<script>
import TypeBlock from '@/web/TypeBlock';
