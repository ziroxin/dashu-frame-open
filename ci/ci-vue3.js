...
// 设置本地目录路径（拷贝打包后的前端文件）
// 改成自己的本地打包目录
const localDirectory = localProjectDir + '\\web-vue3\\dist'
// 改成自己的服务器端目录，例如/home/docker/openresty/html
const remoteDirectory = remoteHomeDirectory + '/openresty/html/dashu-vue3'
// 重启服务命令
...
const copyFiles = ['index.html', 'favicon.ico', 'protocol.html']
