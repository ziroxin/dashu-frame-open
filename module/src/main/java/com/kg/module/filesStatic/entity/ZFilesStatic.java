package com.kg.module.filesStatic.entity;
...
@Getter
@Setter
@TableName("z_files_static")
@ApiModel(value = "ZFilesStatic对象", description = "静态资源文件表")
public class ZFilesStatic implements BaseEntity {
