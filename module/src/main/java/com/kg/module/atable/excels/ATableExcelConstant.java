...
public class ATableExcelConstant {
    ...
    static {
        ...
        EXPORT_EXCEL_COLUMN.put("field116", "测试单行文本");
        EXPORT_EXCEL_COLUMN.put("a", "测试decimal");
        EXPORT_EXCEL_COLUMN.put("b", "测试富文本");
        ...
        IMPORT_EXCEL_COLUMN.put("测试单行文本", "field116");
        IMPORT_EXCEL_COLUMN.put("测试decimal", "a");
        IMPORT_EXCEL_COLUMN.put("测试富文本", "b");
        // 初始化导入必填字段
