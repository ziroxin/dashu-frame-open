package com.kg.module.aTableImages.entity;
...
@Getter
@Setter
@TableName("a_table_images")
@ApiModel(value = "ATableImages对象", description = "我的表a_table附件表")
public class ATableImages implements BaseEntity {
