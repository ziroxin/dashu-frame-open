...
INSERT INTO `z_permission` VALUES ('${importExcelBtnId}', '${menuId}', '${permissionName}-importExcel', '${table.comment!}-导入Excel按钮', '1', '导入Excel按钮', '', '', '', NULL, 1, 1, NULL, 0, 1, 0, NULL, 1, now(), now());
...
INSERT INTO `z_api` VALUES ('${importExcelApiId}', NULL, '导入Excel-${table.comment!}', '${controllerAuthorizePre}import:excel', '${controllerMapping}/import/excel', 'POST', '导入Excel-${table.comment!}', '${table.controllerName}', 'importExcel', 100, now(), now());
...
INSERT INTO `z_permission_api` VALUES ('${importExcelBtnId}', '${importExcelApiId}');
